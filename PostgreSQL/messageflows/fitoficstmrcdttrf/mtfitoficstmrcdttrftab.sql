...
--Table: findata.mtfitoficstmrcdttrftab

--DROP TABLE findata.mtfitoficstmrcdttrftab;

CREATE TABLE findata.mtfitoficstmrcdttrftab (
  ...
  /* Foreign keys */
  CONSTRAINT "FK_MTFTFCSTCT_RM_CORRELID"
...
ALTER TABLE findata.mtfitoficstmrcdttrftab
  OWNER TO findata;

GRANT SELECT, INSERT, UPDATE, DELETE, REFERENCES, TRIGGER, TRUNCATE
  ON findata.mtfitoficstmrcdttrftab
TO findata;
