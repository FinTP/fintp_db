...
--Table: findata.mtpntab

--DROP TABLE findata.mtpntab;

CREATE TABLE findata.mtpntab (
  ...
  dbtid        varchar(50),
  /* Keys */
  CONSTRAINT "PK_MTPNTAB_CORRELID"
    PRIMARY KEY (correlid)
    USING INDEX TABLESPACE findatatbs,
  /* Foreign keys */
  CONSTRAINT "FK_MTPN_RM_CORRELID"
