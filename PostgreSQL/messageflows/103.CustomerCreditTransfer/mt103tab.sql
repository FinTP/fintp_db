...
--Table: findata.mt103tab

--DROP TABLE findata.mt103tab;

CREATE TABLE findata.mt103tab (
  ...
  ttc          varchar(3),
  /* Keys */
  CONSTRAINT "PK_MT103_CORRELID"
    PRIMARY KEY (correlid)
    USING INDEX TABLESPACE findatatbs,
  /* Foreign keys */
  CONSTRAINT "FK_MT103_RM_CORRELID"
