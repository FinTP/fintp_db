  ...
  JOIN (
    (
      (SELECT 
        ...
        'n/a'::character varying AS service 
      FROM findata.mtfitoficstmrcdttrftab 
      UNION
      SELECT 
        mtcoreblklrgrmtcdttrftab.correlid, 
        mtcoreblklrgrmtcdttrftab.msgtype, 
        mtcoreblklrgrmtcdttrftab.valuedate, 
        mtcoreblklrgrmtcdttrftab.amount, 
        mtcoreblklrgrmtcdttrftab.currency, 
        mtcoreblklrgrmtcdttrftab.dbtaccount, 
        mtcoreblklrgrmtcdttrftab.dbtcustname, 
        mtcoreblklrgrmtcdttrftab.ordbank, 
        mtcoreblklrgrmtcdttrftab.benbank, 
        mtcoreblklrgrmtcdttrftab.cdtaccount, 
        mtcoreblklrgrmtcdttrftab.cdtcustname, 
        'n/a'::character varying AS service 
      FROM findata.mtcoreblklrgrmtcdttrftab) 
    UNION
    SELECT 
      mt103tab.correlid, 
      mt103tab.msgtype, 
      ...
      mt103tab.currency, 
      mt103tab.dbtaccount, 
      mt103tab.dbtcustname, 
      mt103tab.ordbank, 
      mt103tab.benbank, 
      mt103tab.cdtaccount, 
      mt103tab.cdtcustname, 
      mt103tab.service 
    FROM findata.mt103tab) 
  UNION
  SELECT 
    mt202tab.correlid, 
    mt202tab.msgtype, 
