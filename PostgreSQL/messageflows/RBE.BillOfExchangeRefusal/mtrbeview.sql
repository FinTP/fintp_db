...
--View: findata.mtrbeview

--DROP VIEW findata.mtrbeview;

CREATE VIEW findata.mtrbeview
(
  guid,
  msgtype,
  sender,
...
ALTER TABLE findata.mtrbeview
  OWNER TO findata;

GRANT SELECT, INSERT, UPDATE, DELETE, REFERENCES, TRIGGER, TRUNCATE
  ON findata.mtrbeview
TO findata;
