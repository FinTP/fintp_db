...
--Table: findata.mtrbetab

--DROP TABLE findata.mtrbetab;

CREATE TABLE findata.mtrbetab (
  ...
  origref      varchar(50),
  /* Keys */
  CONSTRAINT "PK_MTRBETAB_CORRELID"
    PRIMARY KEY (correlid)
    USING INDEX TABLESPACE findatatbs,
  /* Foreign keys */
  CONSTRAINT "FK_MTRBE_RM_CORRELID"
