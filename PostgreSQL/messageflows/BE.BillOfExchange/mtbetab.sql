...
--Table: findata.mtbetab

--DROP TABLE findata.mtbetab;

CREATE TABLE findata.mtbetab (
  ...
  dbtid        varchar(50),
  /* Keys */
  CONSTRAINT "PK_MTBETAB_CORRELID"
    PRIMARY KEY (correlid)
    USING INDEX TABLESPACE findatatbs,
  /* Foreign keys */
  CONSTRAINT "FK_MTBE_RM_CORRELID"
