...
--View: findata.mt104view

--DROP VIEW findata.mt104view;

CREATE VIEW findata.mt104view
(
  guid,
  msgtype,
  sender,
...
ALTER TABLE findata.mt104view
  OWNER TO findata;

GRANT SELECT, INSERT, UPDATE, DELETE, REFERENCES, TRIGGER, TRUNCATE
  ON findata.mt104view
TO findata;
