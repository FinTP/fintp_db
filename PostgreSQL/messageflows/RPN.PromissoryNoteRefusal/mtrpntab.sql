...
--Table: findata.mtrpntab

--DROP TABLE findata.mtrpntab;

CREATE TABLE findata.mtrpntab (
  ...
  origref      varchar(50),
  /* Keys */
  CONSTRAINT "PK_MTRPNTAB_CORRELID"
    PRIMARY KEY (correlid)
    USING INDEX TABLESPACE findatatbs,
  /* Foreign keys */
  CONSTRAINT "FK_MTRPN_RM_CORRELID"
