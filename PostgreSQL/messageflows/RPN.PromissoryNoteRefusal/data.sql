...
INSERT INTO fincfg.msgtypes (mtid, messagetype, friendlyname, displayorder, "storage", businessarea, reportingstorage) VALUES (11, 'RPN', 'PromissoryNoteRefusal', 11, 'MTRPNTAB', 'Debit Instruments/ refusals', 'MTRPNview');
COMMIT;
...
INSERT INTO fincfg.queuemsggroups (msgtype, kword1, kword2, kword3, kword4, kword5) VALUES ('RPN', 'Receiver', 'OrigBatchID', NULL, NULL, NULL);