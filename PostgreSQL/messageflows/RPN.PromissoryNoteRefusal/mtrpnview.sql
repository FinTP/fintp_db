...
--View: findata.mtrpnview

--DROP VIEW findata.mtrpnview;

CREATE VIEW findata.mtrpnview
(
  guid,
  msgtype,
  sender,
...
ALTER TABLE findata.mtrpnview
  OWNER TO findata;

GRANT SELECT, INSERT, UPDATE, DELETE, REFERENCES, TRIGGER, TRUNCATE
  ON findata.mtrpnview
TO findata;
