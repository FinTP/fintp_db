...
--Function: findata.getfirstjob(Output outretcursor refcursor)

--DROP FUNCTION findata.getfirstjob(OUT outretcursor "refcursor");

CREATE OR REPLACE FUNCTION findata.getfirstjob
(
...
ALTER FUNCTION findata.getfirstjob(OUT outretcursor "refcursor")
  OWNER TO findata;
